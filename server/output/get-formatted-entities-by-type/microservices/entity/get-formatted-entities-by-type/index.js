...
const get_formatted_entities_by_type_usecase_1 = require("./get-formatted-entities-by-type.usecase");
...
class EntityController extends base_controller_1.BaseController {
    handler(body, context, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usecase = new get_formatted_entities_by_type_usecase_1.GetFormattedEntitiesByType(schemaEnterpriseRepository, entityRepository);
