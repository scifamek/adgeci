...
exports.handler = exports.Controller = void 0;
...
const get_schemas_type_entity_usecase_1 = require("./get-schemas-type-entity.usecase");
 ...
 */
class Controller extends base_controller_1.BaseController {
    handler(body, context, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usecase = new get_schemas_type_entity_usecase_1.GetSchemasTypeEntityUsecase(schemaEnterpriseRepository);
            const response = yield usecase.call();
            return {
                statusCode: 200,
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    code: (0, response_codes_helpers_1.buildResponseCode)(response_constants_1.BASE_CODE, response_constants_1.RESPONSE_CODES_MAPPER.SCHEMAS_TYPE_ENTITY_SUCCESSFULLY_FOUNDED, enterpriseObj),
                    data: response,
                }),
            };
        });
